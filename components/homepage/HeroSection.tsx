  ...
  return (
    <section className="container mx-auto px-4 py-16 text-center animate-fade-in">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl font-bold mb-6 text-balance animate-fade-in-up">
          Your AI-Powered
        ...
        {/* Features Grid */}
        <div className="grid md:grid-cols-3 gap-6 mb-16 animate-fade-in-up animation-delay-300">
